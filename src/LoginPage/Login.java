...
public class Login extends javax.swing.JFrame {
   ...
   public static Boolean insertUser(String fname, String lname, String email, String username, String password) {
    config connector = new config();
    String query = "INSERT INTO users (fname, lname, email, username, password, status) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    private void initComponents() {
        ...
        jLabel13.setText("School Clinic System");
        jPanel5.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 670, 60));
        ...
        jPanel6.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 320, 320));
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try {
            String query = "SELECT * FROM users WHERE uname = '" + uname.getText() + 
                           "' AND pname = '" + pname.getText() + "'";
            ResultSet rs = conf.getData(query);  // Make sure conf.getData(query) returns a ResultSet

            if (rs.next()) {  // Ensure there is data before accessing rs
                // Session attributes (updated to match your Session class)
